...
def blurb_scrape(url):
    i = 0
    executable_path = {'executable_path': '/home/brad/Documents/Projects/Novel-blurb-NLP/chromedriver'}
...
loop_scrape('https://www.goodreads.com/list/show/348.Thrillers?page=14')